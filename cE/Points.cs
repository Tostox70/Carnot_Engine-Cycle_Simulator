...
public static class Points
{
    ...
    public static float gamma = 5f / 3f - 1f;
    public static float exponent = 1f / gamma;
    public static double gasVolume1 = 0.01;
    public static double gasVolume2 = gasVolume1 * 2; //CANT BE LESS THAN V1
    ...
    // Add these variables for time-based stepping
    ...
    public static void SetTemperatures(int newTH, int newTC)
    {
        if (TH != newTH || TC != newTC)
        {
            TH = newTH;
            TC = newTC;
